<div class="content">
  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <form class="form" action="<?php echo absolute_url("facture/nouveau_detail_facture?num_facture=$num_facture")?>" method="post">
        <h4>Nouvel element</h4>
        <input type="hidden" name="num_facture" value="<?php echo $facture->num_facture ?>" placeholder="Numero bon de commande" required>
  ...
  <div class="row">
      <div class="col-md-10 col-md-offset-1" >
            <h3 class="text text-primary">Facture <?php echo $facture->num_facture ?></h3>
          ...
          <table id="result" class="table table-bordered" >
              <tr>
                  ...
                  <th>Montant</th>
                  <th>x Remise</th>
                  <th>x Remise globale <?php echo $facture->remise ?>%</th>
                  <th>Montant TTC</th>
                  <th></th>
              </tr>
            ...
            <?php
              ...
              foreach($designations as $des) {
                ...
                $montant_redux_global = $montant_redux * (1 - ($facture->remise / 100));
            ...
            ?>
              <tr>
                ...
                <td class="text-right">
                  <a href='<?php echo absolute_url("facture/suppr_detail/$des->iddetailfacture?num_facture=$facture->num_facture") ?>' onclick="return(confirm('Supprimer?'))">
          ...
          <center>"Arrêté le présent facture à la somme de <b><?php echo to_letter_float($total_ttc, $lang, $devise->nom_devise) ?>  </b>"</center>
